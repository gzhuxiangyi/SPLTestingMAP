...
public class Distance {      
  ...
  */
  public double [][] distanceMatrix(SolutionSet solutionSet) {
	  IndividualMultiObj solutionI, solutionJ;
 ...
 * @throws JMException 
  */  
  public double distanceToSolutionSetInObjectiveSpace(IndividualMultiObj    solution, 
  ...
  * @throws JMException 
   */  
//   public double distanceToSolutionSetInSolutionSpace(IndividualMultiObj    solution, 
// 		                                  SolutionSet solutionSet) throws JMException{
//     //At start point the distance is the max
//     double distance = Double.MAX_VALUE;    
//         
 ...
 * @throws JMException 
  */
//  public double distanceBetweenSolutions(IndividualMultiObj solutionI, IndividualMultiObj solutionJ) 
//  throws JMException{                
//    double distance = 0.0;
...
//  } // distanceBetweenSolutions
  ...
  */
  public double distanceBetweenObjectives(IndividualMultiObj solutionI, IndividualMultiObj solutionJ){                
    double diff;    //Auxiliar var
    double distance = 0.0;
    //-> Calculate the euclidean distance

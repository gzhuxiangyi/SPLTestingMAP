...
public class Friedman {
  ...
  public void executeTest(String indic){
    ...
    String outFile = outDir + exp_.nproducts + "prods/FriedmanTest"+indicator_+".tex";
...
//        String ruta = null;//rutaAlg + exp_.problemList_[prob] + "/" + indicator_;	

		String ruta = exp_.experimentBaseDirectory_;
//		ruta += "/" + exp_.experimentName_;
		ruta += "/output/" +  exp_.algorithmNameList_[alg];
		ruta += "/" + exp_.problemList_[prob];
		

		ruta += "/Samples/" + exp_.nproducts + "prods/";
		ruta +=  indicator_;
